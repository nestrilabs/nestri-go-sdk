...
```sh
go get -u 'github.com/nestrilabs/nestri-go-sdk@v0.1.0-alpha.12'
```
...
```go
_, err := client.Tasks.Get(context.TODO(), "faa29bba-c96e-494c-89b0-1f1ec9b87376")
if err != nil {
	...
	panic(err.Error()) // GET "/tasks/{id}": 400 Bad Request { ... }
}
```
