...
func TestUserAgentHeader(t *testing.T) {
	...
	client.Machines.New(context.Background(), "fc27f428f9ca47d4b41b70889ae0c62090")
...
func TestRetryAfter(t *testing.T) {
	...
	res, err := client.Machines.New(context.Background(), "fc27f428f9ca47d4b41b70889ae0c62090")
	if err == nil || res != nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	res, err := client.Machines.New(cancelCtx, "fc27f428f9ca47d4b41b70889ae0c62090")
	if err == nil || res != nil {
		t.Error("Expected there to be a cancel error and for the response to be nil")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		res, err := client.Machines.New(deadlineCtx, "fc27f428f9ca47d4b41b70889ae0c62090")
		if err == nil || res != nil {
